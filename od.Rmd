...
## Trazos dados de observações do parâmetros do banco de dados e cria dataframe tbl
...
tbl <- tbl %>%
   mutate(limite = case_when (Classe==0 ~ 6,
                              Classe==1 ~ 6,
                              Classe==12 ~ 5,
                              Classe==2 ~ 5,
                              Classe==3 ~ 4,
...
# Mapa com frequências de desconformidade
...
mapview(grouped_obs["Desconformidade"],  popup = popupTable(grouped_obs, zcol=c("Código", "Rio", "n", "Média", "Início", "Final", "Classe", "Desconformidade"), row.numbers=FALSE, feature.id=FALSE),
       ...
       # map.types = c("CartoDB.Positron", "Esri.WorldImagery"), 
        ...
        legend = TRUE, 
        col.regions = (pal (100)),
        layer.name = "Desconformidade com a classe (%)")
